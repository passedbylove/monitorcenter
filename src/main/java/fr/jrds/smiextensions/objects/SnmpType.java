...
public enum SnmpType {
    ...
    /**
     * <ul>
     * <li>{@link #getVariable()} return an empty {@link IpAddress} variable.</li>
    ...
    INTEGER {
        ...
        @Override
        public Variable parse(OidInfos oi, String text) {
            return new Integer32(Integer.getInteger(text));
        }
    },
    Integer32 {
        @Override
     ...
     * <li>{@link #convert(Variable)} return the value stored in a {@link Long}.</li>
